...
function withTimeout(p) {
  return Promise.race([p, new Promise((_, reject) => setTimeout(() => reject(new Error("timeout")), NET_TIMEOUT_MS))]);
}
function lsGet(key) {
  try {
  ...
  if (client && cloudAvailable()) {
    try {
      const {
        data,
        error
      } = await withTimeout(client.from(TABLE).select("value").eq("key", key).maybeSingle());
      if (!error) {
        markCloudUp();
...
async function storeSet(key, value) {
  ...
  try {
    const {
      error
    } = await withTimeout(client.from(TABLE).upsert({
      key,
      value
    }, {
      onConflict: "key"
...
async function exportAll() {
  const [goals, foods, combos, index] = await Promise.all([storeGet("goals"), storeGet("saved-foods"), storeGet("combos"), storeGet("log-index")]);
  const logs = {};
...
function MacroBar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "macroLabel"
  }, label), /*#__PURE__*/React.createElement("span", {
    className: "macroNums"
  }, Math.round(value), " ", /*#__PURE__*/React.createElement("span", {
    className: "macroGoal"
  }, "/ ", Math.round(goal), "g"))), /*#__PURE__*/React.createElement("div", {
    className: "macroTrack"
  }, /*#__PURE__*/React.createElement("div", {
    className: "macroFill",
    style: {
      width: `${pct * 100}%`,
...
function AddFoodSheet({
  ...
  const [comboStep, setComboStep] = useState(null); // combo being portioned before adding
  const [comboQty, setComboQty] = useState({}); // name -> qty string
  ...
  // A combo stores the portion it was built with, but the actual meal rarely matches it
  // exactly, so picking a combo opens a step pre-filled with those portions to adjust
  // rather than adding them straight away.
  const openCombo = combo => {
    const initQty = {};
    combo.items.forEach(it => {
      initQty[it.name] = String(it.quantity);
    });
    setComboQty(initQty);
    setComboStep(combo);
  };
  const confirmCombo = () => {
    const items = comboStep.items.map(it => {
      const qty = Number(comboQty[it.name]);
      if (!qty || qty <= 0) return {
        ...it
      };
      return {
        ...it,
        quantity: qty,
        ...scaleEntryQty(it, qty)
      };
    });
    onAddMany(items);
    onClose();
  };
  const comboTotals = comboStep ? comboStep.items.reduce((acc, it) => {
    const qty = Number(comboQty[it.name]) || 0;
    const p = qty > 0 ? scaleEntryQty(it, qty) : {
      calories: 0,
      protein: 0,
      carbs: 0,
      fat: 0
  ...
  const headerTitle = selected ? selected.name : comboStep ? comboStep.name : batchStep ? `設定份量 (${picked.length})` : `加入${mealLabel}`;
  const handleBack = selected ? () => setSelected(null) : comboStep ? () => setComboStep(null) : batchStep ? () => setBatchStep(false) : onClose;
  const showBackArrow = !!(selected || comboStep || batchStep);
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("h3", null, headerTitle), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: handleBack,
    "aria-label": showBackArrow ? "返回" : "關閉"
  }, showBackArrow ? "‹" : "✕")), selected ? /*#__PURE__*/React.createElement("div", {
    className: "newPane"
  }, /*#__PURE__*/React.createElement("label", {
    className: "fieldLabel"
  }, "這次吃了多少", UNIT_LABEL[selected.unit] || "克", "?"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "decimal",
    autoFocus: true,
    value: savedQty,
    ...
    className: "qtyPreview"
  }, preview ? /*#__PURE__*/React.createElement(React.Fragment, null, preview.calories, " kcal · P", preview.protein, " C", preview.carbs, " F", preview.fat) : "輸入份量以預覽營養"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
    onClick: confirmAddSaved,
    disabled: !savedQty
  }, "加入", mealLabel)) : comboStep ? /*#__PURE__*/React.createElement("div", {
    className: "newPane"
  }, /*#__PURE__*/React.createElement("p", {
    className: "stepHint"
  }, "已帶入這個搭配的預設份量，需要的話直接改。"), /*#__PURE__*/React.createElement("div", {
    className: "batchList"
  }, comboStep.items.map(it => {
    const qty = Number(comboQty[it.name]) || 0;
    const p = qty > 0 ? scaleEntryQty(it, qty) : null;
    return /*#__PURE__*/React.createElement("div", {
      className: "batchRow",
      key: it.name
    }, /*#__PURE__*/React.createElement("div", {
      className: "batchRowTop"
    }, /*#__PURE__*/React.createElement("span", {
      className: "batchRowName"
    }, it.name), /*#__PURE__*/React.createElement("div", {
      className: "batchQtyInput"
    }, /*#__PURE__*/React.createElement("input", {
      className: "input batchInput",
      inputMode: "decimal",
      value: comboQty[it.name] ?? "",
      onChange: e => setComboQty(prev => ({
        ...prev,
      ...
      className: "batchUnit"
    }, UNIT_LABEL[it.unit] || "克"))), /*#__PURE__*/React.createElement("div", {
      className: "qtyPreview",
      style: {
        margin: "2px 0 0"
      }
    }, p ? `${p.calories} kcal · P${p.protein} C${p.carbs} F${p.fat}` : "輸入份量以預覽營養"));
  })), comboTotals && /*#__PURE__*/React.createElement("div", {
    className: "comboTotal"
  }, "合計 ", comboTotals.calories, " kcal · P", Math.round(comboTotals.protein * 10) / 10, " C", Math.round(comboTotals.carbs * 10) / 10, " F", Math.round(comboTotals.fat * 10) / 10), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
    onClick: confirmCombo
  }, "加入", mealLabel, " (", comboStep.items.length, " 項)")) : batchStep ? /*#__PURE__*/React.createElement("div", {
    className: "newPane"
  }, /*#__PURE__*/React.createElement("div", {
    className: "batchList"
  }, picked.map(f => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "batchUnit"
    }, UNIT_LABEL[f.unit] || "克"))), /*#__PURE__*/React.createElement("div", {
      className: "qtyPreview",
      style: {
        margin: "2px 0 0"
      }
  ...
  }, "全部加入", mealLabel, " (", picked.length, ")")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "segTabs"
  }, /*#__PURE__*/React.createElement("button", {
    className: tab === "saved" ? "segBtn active" : "segBtn",
    onClick: () => setTab("saved")
  }, "常吃食物"), /*#__PURE__*/React.createElement("button", {
    className: tab === "combos" ? "segBtn active" : "segBtn",
    onClick: () => setTab("combos")
  }, "食物搭配"), /*#__PURE__*/React.createElement("button", {
    className: tab === "new" ? "segBtn active" : "segBtn",
    onClick: () => setTab("new")
  }, "新增食物")), tab === "saved" ? /*#__PURE__*/React.createElement("div", {
    className: "savedPane"
  }, /*#__PURE__*/React.createElement("input", {
    className: "input",
    placeholder: "搜尋食物…",
    ...
    className: "savedList",
    style: {
      paddingBottom: picked.length ? 64 : 0
    }
  }, filtered.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "emptyHint"
  }, savedFoods.length === 0 ? "還沒有常吃食物，先到「新增食物」建立一個吧" : "找不到符合的食物"), filtered.map(f => {
    const isPicked = picked.some(x => x.name === f.name);
    return /*#__PURE__*/React.createElement("div", {
      className: isPicked ? "savedItem picked" : "savedItem",
      key: f.name
    }, /*#__PURE__*/React.createElement("label", {
      className: "pickCheck",
      onClick: e => e.stopPropagation()
      ...
      className: "savedItemBody",
      onClick: () => openSavedQty(f)
    }, /*#__PURE__*/React.createElement("div", {
      className: "savedItemName"
    }, f.name), /*#__PURE__*/React.createElement("div", {
      className: "savedItemMeta"
    }, "每", Number(f.baseAmount) || UNIT_DEFAULT_BASE[f.unit] || 100, UNIT_LABEL[f.unit] || "克", " · ", f.calories, " kcal · P", f.protein, " C", f.carbs, " F", f.fat)));
  })), picked.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "pickBar"
  }, /*#__PURE__*/React.createElement("span", null, "已選 ", picked.length, " 項"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn pickBarBtn",
    onClick: goToBatchStep
  }, "設定份量並加入"))) : tab === "combos" ? /*#__PURE__*/React.createElement("div", {
    className: "savedList"
  }, combos.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "emptyHint"
  }, "還沒有食物搭配，到「常吃食物」頁籤建立一組吧"), combos.map(c => {
    ...
    className: "fieldLabel"
  }, "食物名稱"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    value: name,
    ...
    className: "fieldLabel"
  }, "計量單位"), /*#__PURE__*/React.createElement("div", {
    className: "segTabs",
    style: {
      marginBottom: 12
    }
  }, /*#__PURE__*/React.createElement("button", {
    className: unit === "g" ? "segBtn active" : "segBtn",
    onClick: () => handleUnitChange("g")
  }, "克"), /*#__PURE__*/React.createElement("button", {
    className: unit === "serving" ? "segBtn active" : "segBtn",
    onClick: () => handleUnitChange("serving")
  }, "份")), /*#__PURE__*/React.createElement("label", {
    className: "fieldLabel"
  }, "營養標示是以多少", UNIT_LABEL[unit], "為基準?(看包裝上寫的量)"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "decimal",
    value: baseAmount,
    ...
    className: "fieldLabel"
  }, "熱量 (每", baseAmount || "?", UNIT_LABEL[unit], ", kcal)"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    value: cal,
    ...
    className: "fieldLabel"
  }, "蛋白質(g)"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    value: protein,
    ...
    className: "fieldLabel"
  }, "碳水(g)"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    value: carbs,
    ...
    className: "fieldLabel"
  }, "脂肪(g)"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    value: fat,
    ...
    className: "fieldLabel"
  }, "這次實際吃了多少", UNIT_LABEL[unit], "?"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "decimal",
    value: newQty,
    onChange: e => setNewQty(e.target.value),
    placeholder: baseAmount || String(UNIT_DEFAULT_BASE[unit])
  }), /*#__PURE__*/React.createElement("label", {
    className: "checkRow"
  }, /*#__PURE__*/React.createElement("input", {
    type: "checkbox",
  ...
  }), /*#__PURE__*/React.createElement("span", null, "記住這個食物(存每", baseAmount || "?", UNIT_LABEL[unit], "的營養),加入常吃清單")), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
...
function GoalsSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, "每日目標"), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: onClose,
    "aria-label": "關閉"
  }, "✕")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "fieldLabel"
  }, "熱量目標 (kcal)"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    value: cal,
    onChange: e => setCal(e.target.value)
  ...
  }, "填其中兩項營養素，留空第三項會自動用熱量換算(蛋白質/碳水 4 大卡/g，脂肪 9 大卡/g)"), /*#__PURE__*/React.createElement("div", {
    className: "threeCol"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "fieldLabel"
  }, "蛋白質(g) ", autoField === "protein" && /*#__PURE__*/React.createElement("span", {
    className: "autoTag"
  }, "自動")), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    value: displayValue("protein", protein),
    onChange: e => setProtein(e.target.value),
    style: autoField === "protein" ? {
      color: "var(--green)"
    } : undefined
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "fieldLabel"
  }, "碳水(g) ", autoField === "carbs" && /*#__PURE__*/React.createElement("span", {
    className: "autoTag"
  }, "自動")), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
    ...
    onChange: e => setCarbs(e.target.value),
    style: autoField === "carbs" ? {
      color: "var(--green)"
    } : undefined
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "fieldLabel"
  }, "脂肪(g) ", autoField === "fat" && /*#__PURE__*/React.createElement("span", {
    className: "autoTag"
  }, "自動")), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "numeric",
  ...
  }))), overBudget && /*#__PURE__*/React.createElement("div", {
    className: "qtyPreview",
    style: {
      color: "var(--rose)",
      margin: "-8px 0 16px"
    }
  }, "三項營養素換算的熱量(", Math.round(allocatedCal), " kcal)已超過熱量目標"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
    onClick: save
  }, "儲存目標"))));
}
...
function TodayView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "dateLabel"
  }, fmtLabel(date)), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: () => setDate(addDays(date, 1)),
    disabled: isToday(date),
    style: {
      opacity: isToday(date) ? 0.3 : 1
    },
    "aria-label": "後一天"
  }, "›")), /*#__PURE__*/React.createElement("div", {
    className: "ringCard"
    ...
    pct: pct,
    color: remaining < 0 ? "#C1666B" : "#4A7C59"
  }), /*#__PURE__*/React.createElement("div", {
    className: "ringCenter"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ringNum",
    style: {
      color: remaining < 0 ? "#C1666B" : "#2B2B26"
    }
  }, Math.abs(Math.round(remaining))), /*#__PURE__*/React.createElement("div", {
    className: "ringSub"
  }, remaining < 0 ? "超出 kcal" : "剩餘 kcal"))), /*#__PURE__*/React.createElement("div", {
    className: "macros"
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "mealHeader"
    }, /*#__PURE__*/React.createElement("div", {
      className: "mealTitle"
    }, meal.label), /*#__PURE__*/React.createElement("div", {
      className: "mealCal"
    }, mealCal > 0 ? `${mealCal} kcal` : "")), entries.map(e => /*#__PURE__*/React.createElement("div", {
      className: "entryRow",
      key: e.id
    }, /*#__PURE__*/React.createElement("button", {
      className: "entryInfoBtn",
      onClick: () => onOpenEditQty(meal.key, e)
    }, /*#__PURE__*/React.createElement("div", {
      className: "entryName"
    }, e.name), e.quantity != null && /*#__PURE__*/React.createElement("div", {
      className: "entryQty"
    }, e.quantity, UNIT_LABEL[e.unit] || "克", " ✎")), /*#__PURE__*/React.createElement("div", {
      className: "entryRight"
    }, /*#__PURE__*/React.createElement("span", {
      className: "entryCal"
    }, e.calories, " kcal"), /*#__PURE__*/React.createElement("button", {
      className: "moveBtn",
      onClick: () => onOpenMove(meal.key, e),
      "aria-label": "移動到其他餐"
    }, "⇄"), /*#__PURE__*/React.createElement("button", {
      className: "removeBtn",
      onClick: () => onRemoveEntry(meal.key, e.id),
      "aria-label": "刪除"
    }, "✕")))), /*#__PURE__*/React.createElement("button", {
      className: "addRowBtn",
      onClick: () => onOpenAdd(meal.key)
    }, "+ 新增食物"), /*#__PURE__*/React.createElement("button", {
      className: "importRowBtn",
      onClick: () => onOpenImport(meal.key)
    }, "↺ 從其他天匯入"));
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 24
...
function HistoryView({
  ...
  const days = useMemo(() => {
    ...
    for (let i = 13; i >= 0; i--) {
      ...
      const total = entry ? MEALS.flatMap(m => entry[m.key] || []).reduce((s, e) => s + e.calories, 0) : 0;
      arr.push({
        d,
        key,
        total
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "近 14 天熱量趨勢"), /*#__PURE__*/React.createElement("div", {
    className: "chartCard"
  }, /*#__PURE__*/React.createElement("div", {
    className: "chartBars"
  }, days.map(d => {
    ...
    className: "goalDot"
  }), " 目標 ", goals.calories, " kcal")), /*#__PURE__*/React.createElement("h2", {
    className: "sectionTitle"
  }, "每日紀錄"), /*#__PURE__*/React.createElement("div", {
    className: "historyList"
  }, days.slice().reverse().filter(d => d.total > 0).map(d => /*#__PURE__*/React.createElement("div", {
    className: "historyRow",
    key: d.key
  }, /*#__PURE__*/React.createElement("div", {
    className: "historyDate"
  }, fmtLabel(d.d)), /*#__PURE__*/React.createElement("div", {
    className: d.total > goals.calories ? "historyCal over" : "historyCal"
  }, d.total, " kcal"))), days.every(d => d.total === 0) && /*#__PURE__*/React.createElement("div", {
    className: "emptyHint"
  }, "還沒有紀錄，開始記錄第一餐吧")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 24
    }
  }));
...
function FoodsView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "foodsHeaderRow"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "sectionTitle",
    style: {
      margin: 0
    }
  }, subTab === "foods" ? "常吃食物" : "食物搭配"), /*#__PURE__*/React.createElement("button", {
    className: "addChip",
    onClick: () => subTab === "foods" ? setFoodSheet("new") : setComboSheet("new")
  }, "+ ", subTab === "foods" ? "新增食物" : "新增搭配")), /*#__PURE__*/React.createElement("div", {
    className: "segTabs",
    style: {
      marginBottom: 12
    }
  }, /*#__PURE__*/React.createElement("button", {
    className: subTab === "foods" ? "segBtn active" : "segBtn",
    onClick: () => setSubTab("foods")
  }, "常吃食物"), /*#__PURE__*/React.createElement("button", {
    className: subTab === "combos" ? "segBtn active" : "segBtn",
    onClick: () => setSubTab("combos")
  }, "食物搭配")), subTab === "foods" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("input", {
    className: "input",
    placeholder: "搜尋…",
    value: query,
    onChange: e => setQuery(e.target.value),
    ...
    className: "emptyHint"
  }, "還沒有儲存的食物"), filtered.map(f => /*#__PURE__*/React.createElement("div", {
    className: "savedItem",
    key: f.name
  }, /*#__PURE__*/React.createElement("button", {
    className: "savedItemBody",
    onClick: () => setFoodSheet(f)
  }, /*#__PURE__*/React.createElement("div", {
    className: "savedItemName"
  }, f.name), /*#__PURE__*/React.createElement("div", {
    className: "savedItemMeta"
  }, "每", Number(f.baseAmount) || UNIT_DEFAULT_BASE[f.unit] || 100, UNIT_LABEL[f.unit] || "克", " · ", f.calories, " kcal · P", f.protein, " C", f.carbs, " F", f.fat)), /*#__PURE__*/React.createElement("button", {
    className: "removeBtn",
    ...
    className: "emptyHint"
  }, "還沒有食物搭配，把常一起吃的食物組成一組吧"), combos.map(c => {
    const total = c.items.reduce((s, it) => s + it.calories, 0);
    return /*#__PURE__*/React.createElement("div", {
      className: "savedItem",
      key: c.id,
      ...
      className: "savedItemBody",
      onClick: () => setComboSheet(c)
    }, /*#__PURE__*/React.createElement("div", {
      className: "savedItemName"
    }, c.name), /*#__PURE__*/React.createElement("div", {
      className: "savedItemMeta"
    }, c.items.map(it => it.name).join("、"), " · 共 ", total, " kcal")), /*#__PURE__*/React.createElement("button", {
      className: "removeBtn",
      onClick: () => onDeleteCombo(c.id),
      "aria-label": "刪除"
    }, "✕"));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }), foodSheet && /*#__PURE__*/React.createElement(NewFoodSheet, {
  ...
  }), comboSheet && /*#__PURE__*/React.createElement(ComboBuilderSheet, {
...
function NewFoodSheet({
  ...
  const [baseAmount, setBaseAmount] = useState(initial ? String(Number(initial.baseAmount) || UNIT_DEFAULT_BASE[initial.unit] || 100) : "100");
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, isEdit ? "編輯食物" : "新增食物"), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: onClose,
    "aria-label": "關閉"
  }, "✕")), /*#__PURE__*/React.createElement("div", {
...
function ComboBuilderSheet({
  ...
  const isEdit = !!initial;
  const initialPicked = isEdit ? initial.items.map(it => ({
    name: it.name,
    unit: it.unit,
  ...
  const togglePick = f => {
    setPicked(prev => {
      ...
      setQtyMap(qm => ({
        ...qm,
        [f.name]: String(Number(f.baseAmount) || UNIT_DEFAULT_BASE[f.unit] || 100)
      }));
      return [...prev, f];
    });
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, step === "pick" ? isEdit ? "新增食物到搭配" : "選擇食物搭配" : isEdit ? "編輯搭配" : "設定份量與名稱"), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
  ...
  }, isEdit && step === "pick" || !isEdit && step === "detail" ? "‹" : "✕")), step === "pick" ? /*#__PURE__*/React.createElement("div", {
    className: "savedPane"
  }, /*#__PURE__*/React.createElement("input", {
    className: "input",
    placeholder: "搜尋食物…",
    ...
    className: "emptyHint"
  }, "還沒有常吃食物，先去新增幾個吧"), filtered.map(f => {
    const isPicked = picked.some(x => x.name === f.name);
    return /*#__PURE__*/React.createElement("div", {
      className: isPicked ? "savedItem picked" : "savedItem",
      key: f.name
      ...
      className: "savedItemMeta"
    }, "每", Number(f.baseAmount) || UNIT_DEFAULT_BASE[f.unit] || 100, UNIT_LABEL[f.unit] || "克", " · ", f.calories, " kcal")));
  })), picked.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "pickBar"
  }, /*#__PURE__*/React.createElement("span", null, "已選 ", picked.length, " 項"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn pickBarBtn",
    ...
    className: "fieldLabel"
  }, "搭配名稱"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    value: comboName,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "batchUnit"
    }, UNIT_LABEL[f.unit] || "克"), /*#__PURE__*/React.createElement("button", {
      className: "removeBtn",
    ...
    className: "emptyHint"
  }, "還沒有食物，點下方新增")), /*#__PURE__*/React.createElement("button", {
    className: "addRowBtn",
    onClick: () => setStep("pick"),
    style: {
      marginTop: 10
    }
  }, "+ 新增食物到這個搭配"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
    onClick: save,
    disabled: !comboName.trim() || picked.length === 0,
    style: {
      marginTop: 14
    }
  }, isEdit ? "儲存變更" : "儲存搭配"))));
...
function ImportSheet({
  ...
  const candidates = useMemo(() => {
    const keys = Object.keys(allLogs).filter(k => k !== todayKey).sort((a, b) => a < b ? 1 : -1).slice(0, 14);
    return keys.map(k => {
  ...
  const confirmImport = () => {
    const toImport = selectedDay.entries.filter(e => checked[e.id]).map(e => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, selectedDay ? `匯入${fmtLabel(selectedDay.date)}的${mealLabel}` : `從其他天匯入${mealLabel}`), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: selectedDay ? () => setSelectedDay(null) : onClose,
    "aria-label": selectedDay ? "返回" : "關閉"
  }, selectedDay ? "‹" : "✕")), !selectedDay ? /*#__PURE__*/React.createElement("div", {
    className: "savedList"
  }, candidates.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "emptyHint"
  }, "還沒有其他天的", mealLabel, "紀錄可以匯入"), candidates.map(c => /*#__PURE__*/React.createElement("button", {
    key: c.key,
    className: "savedItem",
    style: {
      width: "100%",
    ...
    className: "savedItemName"
  }, fmtLabel(c.date)), /*#__PURE__*/React.createElement("div", {
    className: "savedItemMeta"
  }, c.entries.map(e => e.name).join("、"), " · 共 ", c.total, " kcal"))))) : /*#__PURE__*/React.createElement("div", {
    className: "newPane"
  }, /*#__PURE__*/React.createElement("div", {
    className: "foodsHeaderRow",
    style: {
  ...
  }, "已選 ", checkedCount, " / ", selectedDay.entries.length, " 項"), /*#__PURE__*/React.createElement("button", {
    className: "addChip",
    onClick: toggleAll
  }, allChecked ? "取消全選" : "全選")), /*#__PURE__*/React.createElement("div", {
    className: "batchList",
    style: {
      marginBottom: 14
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: isChecked ? "batchRow picked" : "batchRow",
      key: e.id,
      style: {
      ...
      className: "batchRowName"
    }, e.name), hasQty && /*#__PURE__*/React.createElement("div", {
      className: "batchQtyInput"
    }, /*#__PURE__*/React.createElement("input", {
      className: "input batchInput",
      inputMode: "decimal",
      disabled: !isChecked,
      value: qtyVal,
      onChange: ev => setQtyMap(prev => ({
        ...prev,
        [e.id]: ev.target.value
      }))
    }), /*#__PURE__*/React.createElement("span", {
      className: "batchUnit"
    }, UNIT_LABEL[e.unit] || "克"))), /*#__PURE__*/React.createElement("div", {
      className: "qtyPreview",
      style: {
        margin: "2px 0 0"
      }
  ...
  }, "匯入已選 (", checkedCount, ")")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 8
    }
  })));
...
function MoveEntrySheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, "移動「", entry.name, "」"), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: onClose,
    "aria-label": "關閉"
  }, "✕")), /*#__PURE__*/React.createElement("div", {
    className: "savedList"
  }, targets.map(m => /*#__PURE__*/React.createElement("button", {
    key: m.key,
    className: "savedItem",
    style: {
      width: "100%",
    ...
    className: "savedItemName"
  }, "移到", m.label)))), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 8
    }
  })));
...
function EditQtySheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, "調整「", entry.name, "」份量"), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: onClose,
    "aria-label": "關閉"
  }, "✕")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "fieldLabel"
  }, "吃了多少", UNIT_LABEL[entry.unit] || "克", "?"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    inputMode: "decimal",
    autoFocus: true,
    value: qty,
    ...
    className: "qtyPreview"
  }, Number(qty) > 0 ? /*#__PURE__*/React.createElement(React.Fragment, null, preview.calories, " kcal · P", preview.protein, " C", preview.carbs, " F", preview.fat) : "輸入份量以預覽營養"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
    onClick: save,
...
function DietTrackerApp() {
  ...
  const checkStorage = useCallback(async () => {
    ...
    try {
      ...
      const {
        data,
        error: rErr
      } = await withTimeout(client.from(TABLE).select("value").eq("key", "__healthcheck__").maybeSingle());
  ...
  const loadAll = useCallback(async () => {
    const [g, sf, cb, logIndex] = await Promise.all([storeGet("goals"), storeGet("saved-foods"), storeGet("combos"), storeGet("log-index")]);
    if (g) setGoals(g);
    setSavedFoods(sf || []);
    setCombos(cb || []);
  ...
  // each other.
  const handleAddEntries = useCallback((mealKey, foods) => {
    setAllLogs(prev => {
      const prevDayLog = prev[dayKey] || {};
      const newEntries = foods.map(f => ({
        id: uid(),
        ...f
      }));
      const newDayLog = {
        ...prevDayLog,
        [mealKey]: [...(prevDayLog[mealKey] || []), ...newEntries]
      };
      const newAllLogs = {
        ...prev,
        [dayKey]: newDayLog
  ...
  const handleRemoveEntry = (mealKey, id) => {
    const newDayLog = {
      ...dayLog,
      [mealKey]: (dayLog[mealKey] || []).filter(e => e.id !== id)
    };
    const newAllLogs = {
      ...allLogs,
      [dayKey]: newDayLog
  ...
  const handleMoveEntry = useCallback((fromMealKey, entryId, toMealKey) => {
    setAllLogs(prev => {
      const prevDayLog = prev[dayKey] || {};
  ...
  const handleUpdateQty = useCallback((mealKey, entryId, newQty) => {
    setAllLogs(prev => {
      const prevDayLog = prev[dayKey] || {};
  ...
  if (!hasConfig) {
    return /*#__PURE__*/React.createElement("div", {
      className: "appRoot"
    }, /*#__PURE__*/React.createElement(Style, null), /*#__PURE__*/React.createElement(SetupScreen, {
      onSaved: () => {
        resetClient();
        setHasConfig(true);
      }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "飲食紀錄"), /*#__PURE__*/React.createElement("div", {
    className: "topBarBtns"
  }, tab === "today" && /*#__PURE__*/React.createElement("button", {
    className: "topBarAction",
    onClick: () => setEditingGoals(true)
  }, "目標"), /*#__PURE__*/React.createElement("button", {
    className: "topBarAction",
    onClick: () => setShowSettings(true)
  }, "設定"))), storageOk === false && /*#__PURE__*/React.createElement("div", {
    className: "storageWarning"
  }, "⚠️ 目前連不上雲端資料庫，變更只會存在這台裝置上，不會同步到其他裝置。請到右上角「設定」檢查金鑰是否正確，或確認網路連線。"), /*#__PURE__*/React.createElement("div", {
    className: "content"
    ...
    onOpenMove: (mealKey, entry) => setMovingEntry({
      mealKey,
      entry
    }),
    onOpenEditQty: (mealKey, entry) => setEditingQtyEntry({
      mealKey,
      entry
    })
    ...
    allLogs: allLogs,
    goals: goals
  }), tab === "foods" && /*#__PURE__*/React.createElement(FoodsView, {
    savedFoods: savedFoods,
    ...
    className: tab === "today" ? "tabBtn active" : "tabBtn",
    onClick: () => setTab("today")
  }, /*#__PURE__*/React.createElement("span", {
    className: "tabIcon"
  }, "◐"), /*#__PURE__*/React.createElement("span", null, "今天")), /*#__PURE__*/React.createElement("button", {
    className: tab === "history" ? "tabBtn active" : "tabBtn",
    onClick: () => setTab("history")
  }, /*#__PURE__*/React.createElement("span", {
    className: "tabIcon"
  }, "▤"), /*#__PURE__*/React.createElement("span", null, "紀錄")), /*#__PURE__*/React.createElement("button", {
    className: tab === "foods" ? "tabBtn active" : "tabBtn",
    onClick: () => setTab("foods")
  }, /*#__PURE__*/React.createElement("span", {
    className: "tabIcon"
  }, "☰"), /*#__PURE__*/React.createElement("span", null, "常吃食物"))), addingMeal && /*#__PURE__*/React.createElement(AddFoodSheet, {
    mealLabel: mealLabel,
    savedFoods: savedFoods,
    combos: combos,
    ...
    onSaveFood: handleSaveFood
  }), importingMeal && /*#__PURE__*/React.createElement(ImportSheet, {
    mealKey: importingMeal,
    mealLabel: importMealLabel,
    allLogs: allLogs,
    todayKey: dayKey,
    onClose: () => setImportingMeal(null),
    onImport: entries => handleAddEntries(importingMeal, entries.map(({
      id,
      ...rest
    }) => rest))
  }), movingEntry && /*#__PURE__*/React.createElement(MoveEntrySheet, {
  ...
  }), editingQtyEntry && /*#__PURE__*/React.createElement(EditQtySheet, {
  ...
  }), editingGoals && /*#__PURE__*/React.createElement(GoalsSheet, {
    goals: goals,
    onClose: () => setEditingGoals(false),
    onSave: handleSaveGoals
  }), showSettings && /*#__PURE__*/React.createElement(SettingsSheet, {
    storageOk: storageOk,
...
function SetupScreen({
  ...
  const connect = async () => {
    ...
    try {
      ...
      const {
        error
      } = await client.from(TABLE).select("key").limit(1);
      if (error) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "連接你的資料庫"), /*#__PURE__*/React.createElement("p", {
    className: "setupIntro"
  }, "第一次使用需要連上你自己的 Supabase 免費資料庫，資料才能在手機和電腦之間同步。 金鑰只會存在這台裝置的瀏覽器裡，不會上傳到 GitHub。每台裝置各設定一次。"), /*#__PURE__*/React.createElement("ol", {
    className: "setupSteps"
  }, /*#__PURE__*/React.createElement("li", null, "到 supabase.com 註冊並建立一個專案"), /*#__PURE__*/React.createElement("li", null, "左側選 SQL Editor，貼上教學裡的建表語法並執行"), /*#__PURE__*/React.createElement("li", null, "左側選 Project Settings → API"), /*#__PURE__*/React.createElement("li", null, "複製 Project URL 和 anon public 金鑰，貼到下方")), /*#__PURE__*/React.createElement("label", {
    className: "fieldLabel"
    ...
    className: "fieldLabel"
  }, "anon public 金鑰"), /*#__PURE__*/React.createElement("input", {
    className: "input",
    value: key,
...
function SettingsSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sheetHeader"
  }, /*#__PURE__*/React.createElement("h3", null, "設定與備份"), /*#__PURE__*/React.createElement("button", {
    className: "iconBtn",
    onClick: onClose,
    "aria-label": "關閉"
  }, "✕")), /*#__PURE__*/React.createElement("div", {
    ...
    className: storageOk ? "statusPill ok" : "statusPill bad"
  }, storageOk ? "● 雲端已連線" : "● 雲端未連線"), /*#__PURE__*/React.createElement("div", {
    className: "sectionLabel"
  }, "備份"), /*#__PURE__*/React.createElement("button", {
    className: "primaryBtn",
    onClick: doExport,
    disabled: busy,
    style: {
  ...
  }, "匯出備份檔"), /*#__PURE__*/React.createElement("div", {
    className: "divider"
  }), /*#__PURE__*/React.createElement("div", {
    className: "sectionLabel"
  }, "匯入資料"), /*#__PURE__*/React.createElement("p", {
    className: "setupIntro",
    style: {
      marginBottom: 10
    }
  }, "從舊版匯出的備份檔可以貼在這裡還原。匯入是「合併」，不會蓋掉你已經輸入的資料。"), /*#__PURE__*/React.createElement("input", {
    type: "file",
    ...
    onClick: doImport,
    disabled: busy
  }, busy ? "處理中…" : "匯入"), msg && /*#__PURE__*/React.createElement("div", {
    className: "okText",
    style: {
      marginTop: 12
    }
    ...
    className: "sectionLabel"
  }, "連線"), /*#__PURE__*/React.createElement("p", {
    className: "setupIntro",
    style: {
      marginBottom: 10
    }
  }, "重設後要重新輸入 Supabase 金鑰。雲端上的資料不會被刪除。"), /*#__PURE__*/React.createElement("button", {
    className: "dangerBtn",
    onClick: onReset
  }, "重設連線設定"))));
}
...
// ---------- mount ----------
ReactDOM.createRoot(document.getElementById("root")).render(/*#__PURE__*/React.createElement(DietTrackerApp, null));
